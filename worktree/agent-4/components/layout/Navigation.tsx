...
function NavLink({ href, icon, label }: NavLinkProps) {
  return (
    <Link
      href={href}
      className="flex items-center gap-2 px-4 py-2.5 text-luxury-white-cream hover:text-luxury-gold-500 hover:bg-luxury-gold-500/10 rounded-lg transition-all text-base font-medium border border-transparent hover:border-luxury-gold-500/20"
    >
      {icon}
      <span>{label}</span>
    </Link>
